...
/// <summary>
/// Provides static methods to handle encryption and decryption of data from "cardlist.dat" (text data) files from Touhou 7.5. This class cannot be inherited.
/// </summary>
public static class CardList
{
	...
	public static Span<byte> Encrypt(ReadOnlySpan<byte> data)
	{
		...
		Crypto.Crypt(outputData, 0x60, 0x61, 0x41);
	...
	public static void Encrypt(Stream inputStream, Stream outputStream)
	{
		...
		Crypto.Crypt(data, 0x60, 0x61, 0x41);
	...
	public static async ValueTask EncryptAsync(Stream inputStream, Stream outputStream)
	{
		...
		Crypto.Crypt(data.Span, 0x60, 0x61, 0x41);
