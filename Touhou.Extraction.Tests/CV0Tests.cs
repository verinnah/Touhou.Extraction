...
public sealed class CV0Tests : IDisposable
{
	private const string TEST_PATH = "test-data\\th105";
	private const string OUTPUT_PATH = $"{TEST_PATH}\\000-test.cv0";

	[Theory]
	[InlineData($"{TEST_PATH}\\000.cv0", 0x62735025cce71bb4)]
	...
	[Theory]
	[InlineData($"{TEST_PATH}\\000.cv0", 0x62735025cce71bb4, true)]
	...
	[Theory]
	[InlineData($"{TEST_PATH}\\000.txt", 0x494fc311e23ea58, 0x62735025cce71bb4)]
